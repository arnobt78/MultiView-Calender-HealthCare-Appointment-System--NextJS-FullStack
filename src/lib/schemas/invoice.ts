...
export const invoiceCreateSchema = z
  .object({
    ...
    /** Required — patient portal lists invoices via appointment → patient chart (invoices-scope). */
    appointment_id: z.string().uuid("Select a visit to link this invoice to a patient chart"),
