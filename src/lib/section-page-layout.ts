 ...
 * - `appEntityDetailRootClass` — entity detail with sticky footer clearance (`pb-24`).
 */
...
/** Entity detail pages with sticky footer bar. */
export const appEntityDetailRootClass = `${appSectionStackClass} pb-24`;
