...
export const visitFeeBadgeCardMetaClass =
  "inline-flex max-w-full min-w-0 items-center gap-1 rounded-full border border-emerald-200/70 bg-emerald-50/80 px-2 py-0.5 text-[10px] font-medium text-emerald-700 shadow-[0_2px_8px_rgba(16,185,129,0.15)] leading-none";

/** Patient booking wizard steps 2–3 + picker tiles — pairs with sky `calendar-glass-badge`. */
export const visitFeeBadgeWizardClass =
  "text-xs py-0 leading-none h-auto min-h-0 font-medium";
...
export const bookingWizardTypeBadgeClass =
  "gap-1 text-xs calendar-glass-badge-sky py-0 leading-none h-auto min-h-0 font-medium";
