...
/** Mount once per doctor/admin layout — shared invoice create/edit dialog for calendar + lists. */
export function ClinicianInvoiceDialogShell({ children, variant, initialInvoices }: Props) {
  return (
