 ...
 * (matches appointment dialog shell) without changing add/remove handlers. Input `h-11` matches login + client row.
 */
...
const glassInputClass =
  "h-11 min-h-[2.75rem] w-full min-w-0 rounded-2xl border border-sky-200/50 bg-white/75 px-3 py-0 text-sm leading-none text-gray-700 shadow-[0_8px_24px_rgba(2,132,199,0.14)] backdrop-blur-md transition-colors placeholder:text-gray-500 focus-visible:border-sky-400/50 focus-visible:ring-2 focus-visible:ring-sky-200/40";
    ...
    <div className="space-y-3 text-gray-700">
      ...
      <div className="space-y-3">
        <div className="flex items-center gap-1.5 text-gray-700">
          ...
          <Label className="text-gray-700">{toTitleCaseLabel("Add Activity")}</Label>
        </div>
        <div className="grid grid-cols-1 gap-2 sm:grid-cols-2 sm:gap-3">
          ...
          />
          <Input
            placeholder={toTitleCaseLabel("Content")}
